...
<div class="row single project evaluate">
    <div class="col-md-12 full">
        <ol class="breadcrumb">
            ...
            <li><a href="{{ url('/evaluation') }}">Project</a></li>
            <li class="active"><a href="#">Evaluation > {{ $evaluate->projects->title }}</a></li>
        </ol>
            ...
            <div class="col-md-9 right-side border-shadow">
                <div class="col-sm-12 full">
                    <div class="col-sm-6 title full">
                        ...
                        <h3 class="page-header"> {{ $evaluate->projects->title }} </h3>
                    </div>
                    <div class="col-sm-6 ref-no full">
                        <h4 class="lbl">Reference Number</h4>
                        <h3 class="page-header"> {{ $evaluate->projects->reference_no }} </h3>
                    </div>
                </div>
                <div class="desc">
                    <h4 class="lbl">Project Description</h4>
                    <p class="details"> {{ $evaluate->projects->description }} </p>
                </div>
            </div>
        </div>
        <div class="cs-section second full next">
            <div class="col-md-8 border-shadow">
                ...
                <table align="center" class="table table-striped table-bordered"> 
                    ...
                    <tr>
                        <td>{{ $evaluate->criterias->type }}</td>
                        <td>{{ $evaluate->criterias->name }}</td>
                        <td>{{ $evaluate->criterias->description }}</td>
                        <td>0</td>
                        <td>1</td>
                        <td>2</td>
                        <td></td>
