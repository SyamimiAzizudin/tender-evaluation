...
<div class="row">
    <div class="col-md-12 full">
        <ol class="breadcrumb">
            ...
            <li class="active">{Name of company}</li>
        </ol>
    </div>
</div>
...
<div class="row users report">
    ...
    <!-- Detailed report for company -->
    <div class="cs-section border-shadow next summary detailed">
        <h3 class="page-header">Detailed Evaluation for {Company A}</h3>
        <table align="center" class="table table-striped table-bordered"> 
            <tr>
                <th width="20%">Description</th>
                <th width="10%" class="center">Weightage</th>
                <th class="center">Edwin</th>
                <th width="10%" class="center"></th>
                <th class="center">Aisyah</th>
                <th width="10%" class="center"></th>
                <th class="center">Amalina</th>
                <th width="10%" class="center"></th>
            </tr>
            <tr>
            	<td>Delivery</td>
